            ...
            foreach (var myArty in myTechNews.articles)
            {
                ...
                switch (i) {
                    ...
                    case 2:
                        ...
                        Uri myuri2 = new Uri(url);
                        techLink2.NavigateUri = myuri2;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run2 = new Run();
                        run2.Text = "View full article here";
                        techLink2.Inlines.Add(run2);
                    ...
                    case 3:
                        ...
                        Uri myuri3 = new Uri(url);
                        techLink3.NavigateUri = myuri3;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run3 = new Run();
                        run3.Text = "View full article here";
                        techLink3.Inlines.Add(run3);
                    ...
                    case 4:
                        ...
                        Uri myuri4 = new Uri(url);
                        techLink4.NavigateUri = myuri4;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run4 = new Run();
                        run4.Text = "View full article here";
                        techLink4.Inlines.Add(run4);
                    ...
                    case 5:
                        ...
                        Uri myuri5 = new Uri(url);
                        techLink5.NavigateUri = myuri5;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run5 = new Run();
                        run5.Text = "View full article here";
                        techLink5.Inlines.Add(run5);
            ...
            foreach (var myArty in myScienceNews.articles)
            {
                ...
                switch(i)
                {
                    ...
                    case 2:
                        ...
                        Uri myuri2 = new Uri(url);
                        scienceLink2.NavigateUri = myuri2;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run2 = new Run();
                        run2.Text = "View full article here";
                        scienceLink2.Inlines.Add(run2);
                    ...
                    case 3:
                        ...
                        Uri myuri3 = new Uri(url);
                        scienceLink3.NavigateUri = myuri3;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run3 = new Run();
                        run3.Text = "View full article here";
                        scienceLink3.Inlines.Add(run3);
                    ...
                    case 4:
                        ...
                        Uri myuri4 = new Uri(url);
                        scienceLink4.NavigateUri = myuri4;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run4 = new Run();
                        run4.Text = "View full article here";
                        scienceLink4.Inlines.Add(run4);
                    ...
                    case 5:
                        ...
                        Uri myuri5 = new Uri(url);
                        scienceLink5.NavigateUri = myuri5;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run5 = new Run();
                        run5.Text = "View full article here";
                        scienceLink5.Inlines.Add(run5);
            ...
            foreach (var myArty in myHealthNews.articles)
            {
                ...
                switch(i)
                {
                    ...
                    case 2:
                        ...
                        Uri myuri2 = new Uri(url);
                        healthLink2.NavigateUri = myuri2;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run2 = new Run();
                        run2.Text = "View full article here";
                        healthLink2.Inlines.Add(run2);
                    ...
                    case 3:
                        ...
                        Uri myuri3 = new Uri(url);
                        healthLink3.NavigateUri = myuri3;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run3 = new Run();
                        run3.Text = "View full article here";
                        healthLink3.Inlines.Add(run3);
                    ...
                    case 4:
                        ...
                        Uri myuri4 = new Uri(url);
                        healthLink4.NavigateUri = myuri4;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run4 = new Run();
                        run4.Text = "View full article here";
                        healthLink4.Inlines.Add(run4);
                    ...
                    case 5:
                        ...
                        Uri myuri5 = new Uri(url);
                        healthLink5.NavigateUri = myuri5;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run5 = new Run();
                        run5.Text = "View full article here";
                        healthLink5.Inlines.Add(run5);
            ...
            foreach (var myArty in myBusinessNews.articles)
            {
                ...
                switch (i)
                {
                    ...
                    case 2:
                        ...
                        Uri myuri2 = new Uri(url);
                        businessLink2.NavigateUri = myuri2;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run2 = new Run();
                        run2.Text = "View full article here";
                        businessLink2.Inlines.Add(run2);
                    ...
                    case 3:
                        ...
                        Uri myuri3 = new Uri(url);
                        businessLink3.NavigateUri = myuri3;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run3 = new Run();
                        run3.Text = "View full article here";
                        businessLink3.Inlines.Add(run3);
                    ...
                    case 4:
                        ...
                        Uri myuri4 = new Uri(url);
                        businessLink4.NavigateUri = myuri4;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run4 = new Run();
                        run4.Text = "View full article here";
                        businessLink4.Inlines.Add(run4);
                    ...
                    case 5:
                        ...
                        Uri myuri5 = new Uri(url);
                        businessLink5.NavigateUri = myuri5;
                        //https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Documents.Hyperlink
                        Run run5 = new Run();
                        run5.Text = "View full article here";
                        businessLink5.Inlines.Add(run5);
